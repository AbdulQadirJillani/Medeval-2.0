...
const Header = ({ questionOrigin, questionID, totalQuestions }: Props) => {
  ...
  return (
    ...
    <div className="my-3 flex justify-between">
      <span className="font-semibold capitalize text-lg text-transparent bg-clip-text bg-gradient-to-r from-[hsl(202,_100%,_56%)] via-[hsl(269,_100%,_61%)] to-[hsl(343,_100%,_50%)]">{name}</span>
      <span className="text-lg text-transparent bg-clip-text bg-gradient-to-r from-[hsl(202,_100%,_56%)] via-[hsl(269,_100%,_61%)] to-[hsl(343,_100%,_50%)]">{questionID} out of {totalQuestions}</span>
    </div>
